...
class Solution{
      ...
      public static int[] solut(int[][] arr){
            ...
            for(int i=0;i<sorted_arr.length;i++){
                        System.out.printf("%d/",ans_frac[i][0]);
                        System.out.printf("%d\n",ans_frac[i][1]);
            }
...
// Returns LCM of array elements 
      ...
      public static double[] SortStatesF(int[][] arr){
            ...
            //adding 1 to absoprtion rows to make them identity matrix
            for(int i=0;i<zero_indices_count;i++){
                  sorted_arr[i][i] = 1;
            }
            
            //Change order as per new indices for R and Q

            int sum=0;
            for(int i=zero_indices_count;i<sorted_arr.length;i++){
                  
                  //Copy the row to swap elemetns of row
                  ...
                  //Swap elements acc to new indices
                  for(int j=0;j<sorted_arr[i].length;j++){
